...
#categories section
@main.route('/pickup/pitch')
def pick_up():
    pitch = Pitch.get_all_pitches()
    title = 'Pitch your pickup lines'
    return render_template('pickup.html',title = title,pitch = pitch)

@main.route('/interview/pitch')
def interview_pitch():
    pitch = Pitch.get_all_pitches()
    title = 'Interview Pitches'
    return render_template('interview.html',title = title,pitch = pitch)
...
def product_pitch():
    ...
    return render_template('product.html',title = title,pitch = pitch)
...
def new_pitch():
    ...
    if form.validate_on_submit():
        pitch= form.pitch.data, form.Category_id.data
